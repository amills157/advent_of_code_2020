...
namespace advent_day_23 {
   ...
   class puzzle_23 {
      ...
      //Outputing debug for partTwo took a while, and made a giant file 
      public static void partTwo(StreamWriter sw, ref int [] cupNumbers)
      {
         ...
         for (int i = 0; i < moves; i++)
         {
               partTwoMove(sw, ref cupLinkedList, ref cupsDict,ref dictKeys);
         }
      ...
      public static void partTwoMove(StreamWriter sw, ref NodeLinkedList cupLinkedList, ref Dictionary<int, Node> cupsDict, ref List<int> dictKeys)
      {
